			...
			<div class="relative z-10 pb-8 bg-white sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
				...
				<main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
					<div class="sm:text-center lg:text-left">
						...
						<p class="text-lg text-gray-500 mt-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium aliquam consectetur cumque dignissimos eos fugiat illo iste quod ratione saepe. Architecto atque culpa excepturi ipsam iste recusandae sed suscipit veritatis?</p>
